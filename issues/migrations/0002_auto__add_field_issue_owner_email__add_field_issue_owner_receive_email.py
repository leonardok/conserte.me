...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Issue.owner_email'
        db.add_column('issues_issue', 'owner_email',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Issue.owner_receive_email'
        db.add_column('issues_issue', 'owner_receive_email',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Issue.owner_email'
        db.delete_column('issues_issue', 'owner_email')

        # Deleting field 'Issue.owner_receive_email'
        db.delete_column('issues_issue', 'owner_receive_email')
