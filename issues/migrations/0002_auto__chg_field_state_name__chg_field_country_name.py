...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('issues_state', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Country.name'
        db.alter_column('issues_country', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'State.name'
        db.alter_column('issues_state', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Country.name'
        db.alter_column('issues_country', 'name', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'issues.photo': {
            ...
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'issue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issues.Issue']"}),
            'name': ('django.db.models.fields.CharField', [], {'default': "'Sem nome'", 'max_length': '100', 'blank': 'True'}),
